...
import main_page.data_modules.match
...
class League:
    ...
    def get_league_results(self):
        ...
        for match_info in response:
            ...
            match = main_page.data_modules.match.Match(match_id)
                ...
                if "1on1" in League.get_league_mode(self) or "Single Elimination" in League.get_league_mode(self):
                    ...
                    if player_a_id is None or player_b_id is None:
                        result = {'Status': 'Match is  still open', 'Match ID': match_id,
                                  'Link': main_page.data_modules.functions.Functions.get_match_link(match_id),
                        ...
                        result = {'Status': 'Match is  still open', 'Match ID': match_id,
                                  'Link': main_page.data_modules.functions.Functions.get_match_link(match_id),
                                  main_page.data_modules.functions.Functions.get_user_link(player_a_id): player_a_id,
                                  main_page.data_modules.functions.Functions.get_user_link(player_b_id): player_b_id}
                        results.append(result)
                else:
                    ...
                    if team_a_id is None or team_b_id is None:
                        ...
                        result = {'Status': 'Match is  still open', 'Match ID': match_id,
                                  'Link': main_page.data_modules.functions.Functions.get_match_link(match_id),
                                  main_page.data_modules.functions.Functions.get_team_link(team_a_id): team_a_id,
                                  main_page.data_modules.functions.Functions.get_team_link(team_b_id): team_b_id}
                        results.append(result)
        return results
    ...
    def get_league_members_info(self):  # have to think about optimisation
        ...
        for contestant in response:
            team = main_page.data_modules.team.Team(contestant['id'])
    ...
    def get_matches_and_players(self):
        ...
        for match in response:
            ...
            match_id_dict = {"match id": match_id,
                             "Match link": main_page.data_modules.functions.Functions.get_match_link(match_id)}
