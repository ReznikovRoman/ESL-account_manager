...
import app_account_manager.main_page.data_modules.user
...
class Match:
                    ...
                    for i in range(len(contestants)):
                        if Match.get_match_mode(self) == "1on1":
                            if contestants[i]['user']['id'] == None:
                                ...
                                contestant = app_account_manager.main_page.data_modules.user.User(contestants[i]['user']['id'])
                            ...
                            if contestants[i]['team']['id'] == None:
                                ...
                                contestant = app_account_manager.main_page.data_modules.team.Team(contestants[i]['team']['id'])
            ...
            for key, value in test_match.get_match_info().items():
                if key == "gameaccounts":
                    ...
                    for key_player, value_player in players.items():
                        new_member = app_account_manager.main_page.data_modules.user.User(key_player)
    ...
    def get_match_results(self):
        ...
        if app_account_manager.main_page.data_modules.functions.Functions.is_error(response):
            ...
            if Match.get_match_mode(self) == "1on1":
                user_win = app_account_manager.main_page.data_modules.user.User(winners)
                user_lose = app_account_manager.main_page.data_modules.user.User(losers)
                user_win_id = ""
                user_win_name = ""
                user_lose_id = ""
                user_lose_name = ""
                ...
                team_win = app_account_manager.main_page.data_modules.team.Team(winners)
                team_lose = app_account_manager.main_page.data_modules.team.Team(losers)
                team_win_id = ""
                team_win_name = ""
                team_lose_id = ""
                team_lose_name = ""
